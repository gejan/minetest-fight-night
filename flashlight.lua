...
technic.register_power_tool("technic:flashlight_off", flashlight_max_charge)
...
minetest.register_tool("technic:flashlight", {
	...
	wield_image = "technic_flashlight_off.png",
	stack_max = 1,
	wear_represents = "technic_RE_charge",
	on_refill = technic.refill_RE_charge,
	on_use = function(itemstack, user, pointed) 
		itemstack:set_name("technic:flashlight_off")
		return itemstack
	end,
})

minetest.register_tool("technic:flashlight_off", {
	description = S("Flashlight off"),
	inventory_image = "technic_flashlight_off.png",
	wield_image = "technic_flashlight_off.png",
	stack_max = 1,
	wear_represents = "technic_RE_charge",
	on_refill = technic.refill_RE_charge,
